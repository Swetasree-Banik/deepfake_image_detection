...
full_dataset = CIFAKEDataset(dataset_path=path, split="train", resolution=RESOLUTION, augment=True)
test_dataset = CIFAKEDataset(dataset_path=path, split="test", resolution=RESOLUTION, augment=False)
